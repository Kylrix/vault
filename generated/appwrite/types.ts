...
export type QueryableKeys<T> = {
  [K in keyof T]: any extends never ? never : K;
}[keyof T];

export type QueryBuilder<T> = {
  equal: <K extends keyof T>(field: K, value: any) => string;
  notEqual: <K extends keyof T>(field: K, value: any) => string;
  lessThan: <K extends keyof T>(field: K, value: any) => string;
  lessThanEqual: <K extends keyof T>(field: K, value: any) => string;
  greaterThan: <K extends keyof T>(field: K, value: any) => string;
  greaterThanEqual: <K extends keyof T>(field: K, value: any) => string;
  contains: <K extends keyof T>(field: K, value: any) => string;
  ...
  between: <K extends keyof T>(field: K, start: any, end: any) => string;
  select: <K extends keyof T>(fields: K[]) => string;
  orderAsc: <K extends keyof T>(field: K) => string;
  orderDesc: <K extends keyof any>(field: K) => string;
...
export type DatabaseTableMap = {
  "67ff05a9000296822396": {
    "notes": {
      ...
      list: (options?: { queries?: (q: { equal: <K extends keyof any>(field: K, value: any) => string; notEqual: <K extends keyof any>(field: K, value: any) => string; lessThan: <K extends keyof any>(field: K, value: any) => string; lessThanEqual: <K extends keyof any>(field: K, value: any) => string; greaterThan: <K extends keyof any>(field: K, value: any) => string; greaterThanEqual: <K extends keyof any>(field: K, value: any) => string; contains: <K extends keyof any>(field: K, value: any) => string; search: <K extends keyof any>(field: K, value: string) => string; isNull: <K extends keyof any>(field: K) => string; isNotNull: <K extends keyof any>(field: K) => string; startsWith: <K extends keyof any>(field: K, value: string) => string; endsWith: <K extends keyof any>(field: K, value: string) => string; between: <K extends keyof any>(field: K, start: any, end: any) => string; select: <K extends keyof Notes>(fields: K[]) => string; orderAsc: <K extends keyof Notes>(field: K) => string; orderDesc: <K extends keyof Notes>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: Notes[] }>;
    };
    "tags": {
      create: (data: {
        "id"?: string | null;
